package com.example.colosseum.widget;
...
import com.example.colosseum.R;
import com.example.colosseum.R.string;
import com.example.colosseum.R.styleable;
...
public class GlowPadView extends View {
    ...
    public GlowPadView(Context context, AttributeSet attrs) {
        ...
        mHandleDrawable = new TargetDrawable(mContext,res, handle != null ? handle.resourceId : 0);
        mHandleDrawable.setState(TargetDrawable.STATE_ACTIVE);
        mOuterRing = new TargetDrawable(mContext,res,
    ...
    private ArrayList<TargetDrawable> loadDrawableArray(int resourceId) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            TargetDrawable target = new TargetDrawable(mContext,res, value != null ? value.resourceId : 0);
    ...
    private void internalSetTargetResources(int resourceId) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            target.setState(TargetDrawable.STATE_ACTIVE);
            target.setDescription(mContext.getString(targetDescriptionId[i]));
        }
    ...
    private static int[] targetDescriptionId = new int[]{R.string.target_storelocator,
    R.string.target_antitheft,
    R.string.target_authentication,
    R.string.target_buy,
    R.string.target_resale,
    R.string.target_brand,
    R.string.target_communicate,
    R.string.target_geolocation};  
