...
import com.example.colosseum.R.dimen;
...
public class TargetDrawable {
    ...
    public static final int[] STATE_PRESSED =
        { android.R.attr.state_pressed, -android.R.attr.state_active,
            android.R.attr.state_focused };
    ...
    public TargetDrawable(Context context,Resources res, int resId) {
        mResourceId = resId;
...
//            }
    ...
    public void draw(Canvas canvas) {
        ...
        if(mDescription != null){
        	...
        	int textSize = (int) mResources.getDimension(R.dimen.colosseum_target_description_size);
            paint.setTextSize(textSize);
        	canvas.drawText(mDescription, (mDrawable.getIntrinsicWidth()-mDescription.length()*textSize)/2, mDrawable.getIntrinsicHeight()+20, paint);
        }
        canvas.restore();
    }
